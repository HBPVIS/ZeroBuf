...
{
template <>
ZEROBUF_INL bool fromJSON(const Json::Value& json)
{
    return json.asBool();
}
template <>
ZEROBUF_INL int8_t fromJSON(const Json::Value& json)
{
    return json.asInt();
}
template <>
ZEROBUF_INL uint8_t fromJSON(const Json::Value& json)
{
    return json.asUInt();
}
template <>
ZEROBUF_INL int16_t fromJSON(const Json::Value& json)
{
    return json.asInt();
}
template <>
ZEROBUF_INL uint16_t fromJSON(const Json::Value& json)
{
    return json.asUInt();
}
template <>
ZEROBUF_INL int32_t fromJSON(const Json::Value& json)
{
    return json.asInt();
}
template <>
ZEROBUF_INL uint32_t fromJSON(const Json::Value& json)
{
    return json.asUInt();
}
template <>
ZEROBUF_INL int64_t fromJSON(const Json::Value& json)
{
    return json.asInt64();
}
template <>
ZEROBUF_INL uint64_t fromJSON(const Json::Value& json)
{
    return json.asUInt64();
}
template <>
ZEROBUF_INL float fromJSON(const Json::Value& json)
{
    return json.asFloat();
}
template <>
ZEROBUF_INL double fromJSON(const Json::Value& json)
{
    return json.asDouble();
}
template <>
ZEROBUF_INL std::string fromJSON(const Json::Value& json)
{
    return json.asString();
}
template <>
ZEROBUF_INL uint128_t fromJSON(const Json::Value& json)
{
    return {json["high"].asUInt64(), json["low"].asUInt64()};
}

template <class T>
void toJSON(const T& value, Json::Value& json)
{
...
template <>
ZEROBUF_INL void toJSON(const uint8_t& value, Json::Value& json)
{
    json = Json::UInt(value);
}
template <>
ZEROBUF_INL void toJSON(const uint16_t& value, Json::Value& json)
{
    json = Json::UInt(value);
}
template <>
ZEROBUF_INL void toJSON(const int64_t& value, Json::Value& json)
{
    json = Json::Int64(value);
}
template <>
ZEROBUF_INL void toJSON(const uint64_t& value, Json::Value& json)
{
    json = Json::UInt64(value);
}
template <>
ZEROBUF_INL void toJSON(const uint128_t& value, Json::Value& json)
{
